                      ...
                      <div class="box-header">
                        ...
                        @endif
                                        ...
                                        <div class="box-body">
                                            ...
                                            <form method="POST" action="{{ url('admin/customers/add') }}" class="form-horizontal form-validate" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="text" name="customers_email" id="customers_email" class="form-control field-validate">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="text" name="customers_phone" id="customers_phone" class="form-control field-validate">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="text" name="address" id="pac-input" placeholder="Enter a location" class="form-control field-validate">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="text" name="city" id="city" class="form-control field-validate" readonly>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="text" name="pincode" id="pincode" class="form-control field-validate" readonly>
