...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> Drivers <small>Edit Driver...</small> </h1>
            <ol class="breadcrumb">
                      ...
                      <div class="box-header">
                        ...
                        @endif
                                        ...
                                        <div class="box-body">
                                            ...
                                            <form method="POST" action="{{ url('admin/drivers/update') }}" class="form-horizontal form-validate">
                                            @csrf
                                            
                                            <input type="hidden" name="id" id="id" value="{{$result['drivers'][0]->id }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="text" name="name" id="name" class="form-control field-validate" value="{{$result['drivers'][0]->name }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="text" name="drivers_email" id="drivers_email" class="form-control field-validate" value="{{$result['drivers'][0]->email }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="text" name="drivers_phone" id="drivers_phone" class="form-control field-validate" value="{{$result['drivers'][0]->user_phone }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="text" name="address" id="address" class="form-control field-validate" value="{{$result['drivers'][0]->user_address }}">
