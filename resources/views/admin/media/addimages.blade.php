...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> Add New Image <small>Listing All The Images...</small> </h1>
        <ol class="breadcrumb">
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Listing All The Images </h3>
                        ...
                        @if(isset($images))
                            ...
                            <div class="col-xs-4 col-md-2 margin-bottomset">
                                <div class="thumbnail thumbnail-imges">
                                    <img class="test_image" image_id="{{$image->images_id}}" src="{{asset('public').'/'.$image->images_path}}" alt="...">
                                </div>
                                <a class="btn btn-block btn-primary" href="{{url('admin/media/detail')}}/{{$image->images_id}}"> View Detail</a>
                            </div>
                            @endforeach
                        @endif
        ...
        <!-- <div class="modal fade" id="myModaldetail" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form method="POST" action="{{ url('admin/deleteimage') }}" class="form-horizontal" enctype="multipart/form-data" onsubmit="return ConfirmDelete()" >
                        @csrf
