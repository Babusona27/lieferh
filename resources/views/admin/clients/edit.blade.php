                      ...
                      <div class="box-header">
                        ...
                        @endif
                                        ...
                                        <div class="box-body">
                                            ...
                                            <form method="POST" action="{{ url('admin/client/update') }}" class="form-horizontal form-validate" enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden" name="id" id="id" value="{{$result['clients'][0]->id }}">
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">Company Name<span style="color:red;">*</span>

                                                </label>
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="text" name="company_name" id="company_name" class="form-control field-validate" value="{{$result['clients'][0]->company_name }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="text" name="sur_name" id="sur_name" class="form-control field-validate" value="{{$result['clients'][0]->sur_name }}">
                                                    <span class="help-block hidden">This field is required.</span>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="text" name="name" id="name" class="form-control field-validate" value="{{$result['clients'][0]->name }}">
                                                    <span class="help-block hidden">This field is required.</span>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="text" name="middle_name" id="middle_name" class="form-control" value="{{$result['clients'][0]->middle_name }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="text" name="email" id="email" class="form-control field-validate" value="{{$result['clients'][0]->email }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="text" name="user_phone" id="user_phone" class="form-control field-validate"  value="{{$result['clients'][0]->user_phone }}">
                                                    <span class="help-block hidden">This field is required.</span>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="text" name="alt_mobile" id="alt_mobile" class="form-control"  value="{{$result['clients'][0]->alt_mobile }}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="time" name="best_time_to_contact" id="best_time_to_contact" class="form-control" value="{{$result['clients'][0]->best_time_to_contact }}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="text" name="regi_no" id="regi_no" class="form-control field-validate" value="{{$result['clients'][0]->regi_no }}">
                                                    <span class="help-block hidden">This field is required.</span>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="text" name="vat_no" id="vat_no" class="form-control field-validate" value="{{$result['clients'][0]->vat_no }}">
                                                    <span class="help-block hidden">This field is required.</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="text" name="user_address" id="pac-input" placeholder="Enter a location" class="form-control field-validate"  value="{{$result['clients'][0]->user_address }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="text" name="user_city" id="user_city" class="form-control field-validate" value="{{$result['clients'][0]->user_city }}" readonly>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="text" name="user_pincode" id="user_pincode" class="form-control field-validate" value="{{$result['clients'][0]->user_pincode }}" readonly>
                                                    
                                                    {{-- <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">Pincode such as "123456"</span> --}}
                                                    <span class="help-block hidden">This field is required.</span>
                                                </div>
                                            </div>
                                            <input type="hidden" name="latitude" id="cityLat" class="form-control field-validate" value="{{$result['clients'][0]->latitude }}">
                                            <input type="hidden" name="longitude" id="cityLng" class="form-control field-validate" value="{{$result['clients'][0]->longitude }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="text" name="alt_adddress" id="alt_adddress" placeholder="Enter a location" class="form-control field-validate" value="{{$result['clients'][0]->alt_adddress }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="text" name="alt_city" id="alt_city" class="form-control field-validate" value="{{$result['clients'][0]->alt_city }}" readonly>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="text" name="alt_pincode" id="alt_pincode" class="form-control field-validate" value="{{$result['clients'][0]->alt_pincode }}" readonly>
                                                    
                                                    {{-- <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">Pincode such as "123456"</span> --}}
                                                    <span class="help-block hidden">This field is required.</span>
                                                </div>
                                            </div>
                                            <input type="hidden" name="alt_latitude" id="alt_latitude" class="form-control field-validate" value="{{$result['clients'][0]->alt_latitude }}">
                                            <input type="hidden" name="alt_longitude" id="alt_longitude" class="form-control field-validate" value="{{$result['clients'][0]->alt_longitude }}">
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">Status<span style="color:red;">*</span>

                                                </label>
                                                <div class="col-sm-10 col-md-4">
                                                    <select name="user_status" id="user_status" class="form-control field-validate">
                                                        <option value="1" <?php if(!empty($result['clients'][0])){echo $result['clients'][0]->user_status=='1'?"selected":''; } ?> >Active</option>
                                                        <option value="0" <?php if(!empty($result['clients'][0])){echo $result['clients'][0]->user_status=='0'?"selected":''; } ?> >Inactive</option>
                                                    </select>
                                                    <span class="help-block hidden">This field is required.</span>
                                                </div>
                                            </div>
